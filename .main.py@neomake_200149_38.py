...
inputGRE = st.text_input("Masukan Score GRE: ", 0)
inputTOEFL = st.text_input("Masukan TOEFl Score: ", 0)
inputUnivRating = st.text_input("Masukan Rating Universitas: ", 0)
inputSOP = st.text_input("Masukan Kekuatan SOP: ", 0)
inputLOR = st.text_input("Masukan Kekuatan Surat Rekomendasi: ", 0)
inputCGPA = st.text_input("Masukan CGPA Kamu: ", 0)
inputResearch = st.text_input("Masukan 1 Jika ada Pengalaman Riset dan 0 Jika Tidak ada", 0)
